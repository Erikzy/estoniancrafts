...
class WP_Job_Manager_Writepanels {
	...
	public function job_listing_fields() {
		...
		$fields = array(
                    ...
                    '_job_upper_price' => array(
                        'label' => __('Upper price', 'wp-job-manager'),
		...
		if (false && $current_user->has_cap( 'manage_job_listings' ) ) {
		...
		if (false && $current_user->has_cap( 'edit_others_job_listings' ) ) {
