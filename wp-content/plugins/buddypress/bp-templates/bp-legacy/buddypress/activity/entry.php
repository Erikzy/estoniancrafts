			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_activity_can_favorite() ) : ?>
					...
					<?php if ( !bp_get_activity_is_favorite() ) : ?>
						...
						<a href="<?php bp_activity_favorite_link(); ?>" class="button fav bp-secondary-action smaller-gray-button"><?php _e( 'Favorite', 'buddypress' ); ?></a>

					<?php else : ?>

						<a href="<?php bp_activity_unfavorite_link(); ?>" class="button unfav bp-secondary-action smaller-gray-button"><?php _e( 'Remove Favorite', 'buddypress' ); ?></a>
