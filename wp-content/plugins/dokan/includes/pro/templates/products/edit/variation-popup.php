                                            ...
                                            <select name="attribute_{{index}}[]">
                                                <option value=""><?php _e( 'Any ', 'dokan' ); ?>{{title.name}}…</option>
                                                    <# _.each( title.term, function( term_val, term_key ) {
                                                         ...
                                                         #>
                                                        <option value="{{term_val}}" {{ selected }}>{{term_val}}</option>
                                                    <# }); #>
                                            </select>
                                        <# }); #>
                                    ...
                                    <table cellspacing="0" cellpadding="0" class="woocommerce_variable_attributes wc-metabox-content">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="options">
                                                    <label class="checkbox"><input type="checkbox"  {{ ( !_.isUndefined( data.variation_post_status ) && ( data.variation_post_status[0] == 'publish' ) ) ? 'checked="checked"': '' }} name="variable_enabled[]" class="checkbox"> <?php _e( 'Enabled' , 'dokan' ) ?></label>

                                                    <label class="checkbox"><input type="checkbox" {{ ( !_.isUndefined( data._downloadable ) && data._downloadable == 'yes' ) ? 'checked="checked"': '' }} name="variable_is_downloadable[]" class="checkbox variable_is_downloadable"> <?php _e( 'Downloadable' , 'dokan' ) ?> <a href="#" title="" class="tips" data-original-title="Enable this option if access is given to a downloadable file upon purchase of a product">[?]</a></label>
