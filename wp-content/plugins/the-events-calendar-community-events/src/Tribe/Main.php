...
if ( ! class_exists( 'Tribe__Events__Community__Main' ) ) {
	...
	class Tribe__Events__Community__Main {
		...
		public function __construct() {
			...
			add_filter( 'tribe_events_linked_post_type_args', array( $this, 'filter_linked_post_type_creation' ), 20, 2 );
		...
		public function filter_linked_post_type_creation( $args, $post_type ) {
			if ( ! isset( $this->users_can_create[ $post_type ] ) ) {
				return $args;
			}
			$post_type_object = get_post_type_object( $post_type );

			// Don't Overwrite for users that have `create_posts` caps
			if (
			...
			$args['allow_creation'] = $this->users_can_create[ $post_type ];
		...
		public function register_resources() {
			...
			tribe_asset(
				$this,
				'tribe-events-community-select2',
				'tribe-events-community-select2.css'
			);
			...
			tribe_asset(
				...
				$stylesheet_url,
				array( 'tribe-datepicker', 'tribe-events-community-select2', 'tribe-dependency-style' )
			);
