...
if ( apply_filters( 'tribe_events_community_display_cost_section', true ) ) {
	?>
	<div id="event_cost" class="tribe-events-community-details eventForm bubble event-cost">

		<div class="tribe_sectionheader">
			<h4 tabindex="0"><?php printf( esc_html__( '%s Cost', 'tribe-events-community' ), $events_label_singular ); ?></h4>
		</div><!-- .tribe_sectionheader -->

		<div class="event-cost-details">

			<div class="currency-symbol-fields">
				<?php tribe_community_events_field_label( 'EventCurrencySymbol', __( 'Currency Symbol:', 'tribe-events-community' ) ); ?>
				<input id="EventCurrencySymbol" class="event-currency-symbol" type="text" name="EventCurrencySymbol" size="2" value="<?php echo esc_attr( isset( $_POST['EventCurrencySymbol'] ) ? $_POST['EventCurrencySymbol'] : tribe_community_events_form_currency_symbol() ); ?>" />
				<div class="select">
					<select id="EventCurrencyPosition" class="event-currency-position tribe-dropdown" name="EventCurrencyPosition" aria-label="<?php esc_html_e( 'Events Currency Position', 'tribe-events-community' ); ?>">
						<?php
			...
			<div class="cost-input-field">
				...
				<input type="text" id="EventCost" name="EventCost" size="6" value="<?php echo esc_attr( isset( $_POST['EventCost'] ) ? $_POST['EventCost'] : tribe_get_cost() ); ?>" />
			</div>
			<div class="more-info small-text"><?php printf( __( 'Leave blank to hide the field. Enter a 0 for %s that are free.', 'tribe-events-community' ), $events_label_plural_lowercase ); ?></div>
