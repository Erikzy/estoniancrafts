jQuery(document).ready(function (jQuery) {
    jQuery('.eh_crm_support_main').on('submit','form#eh_crm_ticket_form',function (e) {
        var btn = jQuery("#crm_form_submit").button('loading');
        var fd = new FormData();
    ...
    jQuery('.eh_crm_support_main').on('click', 'button.eh_crm_new_request', function (e) {
        ...
        jQuery.ajax({
            ...
            success: function (data)
            {
                ...
                jQuery('.support_option_choose .eh_crm_new_request').hide();
                jQuery('.support_option_choose .eh_crm_check_request').show();
    ...
    /*setInterval(function()
    {
        if(jQuery(".tickets_panel").length != 0)
        {
            eh_crm_check_ticket_request(".table_loader","table")
        }
    }, 120000);*/
    ...
    function eh_crm_check_ticket_request(comp,load='')
    {
        if(load=='')
        ...
        jQuery.ajax({
            ...
            success: function (data)
            {
                ...
                {
                    jQuery('.support_option_choose').show();
                    jQuery('.support_option_choose .eh_crm_new_request').show();
                    jQuery('.support_option_choose .eh_crm_check_request').hide();
                    jQuery('.main_new_suppot_request_form').remove();
