...
if($user!="all")
{
    ...
    if($user_check)
    {
        ...
        $role = !empty(array_intersect($user_roles_default,$user_check->roles));
        if($role)
        {
        ...
        <div class="col-md-12">
            <div class="panel panel-default reports_panel">
                <div class="panel-heading">
                    <h3 class="panel-title">WSDesk Reports</h3>
                </div>
                <div class="panel-body" id="reports_panel_body" style="text-align: center">
                    <span class="help-block">Select the Agents/Supervisors to show report?</span>
                    <span style="vertical-align: middle;" id="ticket_field_edit_section">
                        <form method="GET">
                            ...
                            <br>
                            <input type="submit" style="margin-top: 10px" class="btn btn-primary" value="Show Report">
                        </form>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Last 7 Days status of new tickets : <?php echo $user_name; ?> </h3>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Last 7 Days status of Agent Tickets : <?php echo $user_name; ?></h3>
                                </div>
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                ...
                <div class="row" style="padding-top: 10px;">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Last 7 Days status of New and Solved Tickets : <?php echo $user_name; ?></h3>
                                </div>
                                <div class="panel-body">
