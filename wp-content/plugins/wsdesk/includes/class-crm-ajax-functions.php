...
class CRM_Ajax {
    ...
    static function eh_crm_ticket_field() {
        ...
        $fields_remove = explode(",", sanitize_text_field($_POST['fields_remove']));
        ...
        for ($i = 0; $i < count($avail_fields); $i++) {
            if (in_array($avail_fields[$i]["slug"], $fields_remove)) {
    ...
    static function eh_crm_ticket_field_edit() {
        ...
        $add_value = '<button class="button" id="ticket_field_edit_values_add" style="vertical-align: baseline;margin-bottom: 10px;">Add Value</button>';
        $remove_value = '<button class="button" id="ticket_field_edit_values_remove" style="margin:0px 10px; vertical-align: baseline;margin-bottom: 10px;">Remove Value</button>';
        $output = '<span class="help-block">Edit Details for custom ' . ucfirst($field_meta['field_type']) . '? </span>';
        $output .= '<input type="text" id="ticket_field_edit_title" placeholder="Enter Title" class="form-control crm-form-element-input" value="' . $field_sett[0]['title'] . '">';
        switch ($field_meta['field_type']) {
            ...
            case 'file':
                ...
                $output .= '<span class="help-block">Specify whether this Field is Optional or Required? </span><input type="radio" style="margin-top: 0;"  id="ticket_field_edit_require" class="form-control" name="ticket_field_edit_require" ' . $required . ' value="yes"> Yes! This Field is Mandatory<br><input type="radio" style="margin-top: 0;" id="ticket_field_edit_require" class="form-control" name="ticket_field_edit_require" ' . $optional . ' value="no"> No! Its an Optional Field <br>';
                $output .= '<br><span class="help-block">Specify whether this Field is Single or Multiple Attachment? </span><input type="radio" style="margin-top: 0;"  id="ticket_field_edit_file_type" checked class="form-control" name="ticket_field_edit_file_type" ' . $single .' value="single"> Single Attachment <br><input type="radio" style="margin-top: 0;" id="ticket_field_edit_file_type" class="form-control" name="ticket_field_edit_file_type" ' . $multiple . ' value="multiple"> Multiple Attachment <br>';
                $output .= '<br><span class="help-block">Want to update description to this field? </span><textarea id="ticket_field_edit_description" class="form-control crm-form-element-input" style="padding: 10px !important;">' . $field_meta['field_description'] . '</textarea>';
                $output .= '<span class="help-block">Want to use this field for Filter Tickets? </span><input type="radio" style="margin-top: 0;"  id="ticket_field_edit_filter" class="form-control" name="ticket_field_edit_filter" ' . $yes . ' value="yes"> Yes! I will use it for Filter<br><input type="radio" style="margin-top: 0;" id="ticket_field_edit_filter" class="form-control" name="ticket_field_edit_filter" ' . $no . ' value="no"> No! Just for Information<br>';
                break;
            case 'radio':
                $output .= '<span class="help-block">Update the Radio values! </span>';
                $field_values = array_values($field_meta['field_values']);
                for ($i = 0; $i < count($field_values); $i++) {
                    $output .= '<input type="text" id="ticket_field_edit_values[' . $i . ']" class="form-control ticket_field_edit_values crm-form-element-input" value="' . $field_values[$i] . '">';
                }
                $output .= $add_value . $remove_value;
                $output .= '<br><input type="text" id="ticket_field_edit_default" placeholder="Enter Default Values" class="form-control crm-form-element-input" value="' . $field_meta['field_values'][$field_meta['field_default']] . '">';
                $output .= '<br><span class="help-block">Want to update description to this field? </span><textarea id="ticket_field_edit_description" class="form-control crm-form-element-input" style="padding: 10px !important;">' . $field_meta['field_description'] . '</textarea>';
                $output .= '<span class="help-block">Want to use this field for Filter Tickets? </span><input type="radio" style="margin-top: 0;"  id="ticket_field_edit_filter" class="form-control" name="ticket_field_edit_filter" ' . $yes . ' value="yes"> Yes! I will use it for Filter<br><input type="radio" style="margin-top: 0;" id="ticket_field_edit_filter" class="form-control" name="ticket_field_edit_filter" ' . $no . ' value="no"> No! Just for Information<br>';
                break;
            case 'checkbox':
                $output .= '<span class="help-block">Update the Checkbox values! </span>';
                $field_values = array_values($field_meta['field_values']);
                for ($i = 0; $i < count($field_values); $i++) {
                    $output .= '<input type="text" id="ticket_field_edit_values[' . $i . ']" class="form-control ticket_field_edit_values crm-form-element-input" value="' . $field_values[$i] . '">';
                }
                ...
                break;
            case 'select':
                $output .= '<span class="help-block">Update the Dropdown values! </span>';
                $field_values = array_values($field_meta['field_values']);
                for ($i = 0; $i < count($field_values); $i++) {
                    $output .= '<input type="text" id="ticket_field_edit_values[' . $i . ']" class="form-control ticket_field_edit_values crm-form-element-input" value="' . $field_values[$i] . '">';
                }
            ...
            case 'textarea':
                ...
                $output .= '<span class="help-block">Specify whether this Field is Optional or Required? </span><input type="radio" style="margin-top: 0;"  id="ticket_field_edit_require" class="form-control" name="ticket_field_edit_require" ' . $required . ' value="yes"> Yes! This Field is Mandatory<br><input type="radio" style="margin-top: 0;" id="ticket_field_edit_require" class="form-control" name="ticket_field_edit_require" ' . $optional . ' value="no"> No! Its an Optional Field <br>';
                $output .= '<br><input type="text" id="ticket_field_edit_default" placeholder="Enter Default Values" class="form-control crm-form-element-input" value="' . $field_meta['field_default'] . '">';
                $output .= '<br><span class="help-block">Want to update description to this field? </span><textarea id="ticket_field_edit_description" class="form-control crm-form-element-input" style="padding: 10px !important;">' . $field_meta['field_description'] . '</textarea>';
                $output .= '<span class="help-block">Want to use this field for Filter Tickets? </span><input type="radio" style="margin-top: 0;"  id="ticket_field_edit_filter" class="form-control" name="ticket_field_edit_filter" ' . $yes . ' value="yes"> Yes! I will use it for Filter<br><input type="radio" style="margin-top: 0;" id="ticket_field_edit_filter" class="form-control" name="ticket_field_edit_filter" ' . $no . ' value="no"> No! Just for Information<br>';
                break;
            default :
                ...
                $output .= '<span class="help-block">Specify whether this Field is Optional or Required? </span><input type="radio" style="margin-top: 0;"  id="ticket_field_edit_require" class="form-control" name="ticket_field_edit_require" ' . $required . ' value="yes"> Yes! This Field is Mandatory<br><input type="radio" style="margin-top: 0;" id="ticket_field_edit_require" class="form-control" name="ticket_field_edit_require" ' . $optional . ' value="no"> No! Its an Optional Field <br>';
                $output .= '<br><input type="text" id="ticket_field_edit_placeholder" placeholder="Enter Placeholder" class="form-control crm-form-element-input" value="' . $field_meta['field_placeholder'] . '">';
                $output .= '<br><input type="text" id="ticket_field_edit_default" placeholder="Enter Default Values" class="form-control crm-form-element-input" value="' . $field_meta['field_default'] . '">';
                $output .= '<br><span class="help-block">Want to update description to this field? </span><textarea id="ticket_field_edit_description" class="form-control crm-form-element-input" style="padding: 10px !important;">' . $field_meta['field_description'] . '</textarea>';
                $output .= '<span class="help-block">Want to use this field for Filter Tickets? </span><input type="radio" style="margin-top: 0;"  id="ticket_field_edit_filter" class="form-control" name="ticket_field_edit_filter" ' . $yes . ' value="yes"> Yes! I will use it for Filter<br><input type="radio" style="margin-top: 0;" id="ticket_field_edit_filter" class="form-control" name="ticket_field_edit_filter" ' . $no . ' value="no"> No! Just for Information<br>';
                break;
    ...
    static function eh_crm_ticket_label() {
        $labels_remove = explode(",", sanitize_text_field($_POST['labels_remove']));
        ...
        for ($i = 0; $i < count($avail_labels); $i++) {
            if (in_array($avail_labels[$i]["slug"], $labels_remove)) {
    ...
    static function eh_crm_ticket_label_edit() {
        ...
        $output = '     
                    <span class="help-block">Update Details for ' . $label_sett[0]['title'] . ' Label? </span>
                    ...
                    <span class="help-block">Want to use this label for Filter Tickets? </span>
    ...
    static function eh_crm_ticket_tag() {
        $tags_remove = explode(",", sanitize_text_field($_POST['tags_remove']));
        ...
        for ($i = 0; $i < count($avail_tags); $i++) {
            if (in_array($avail_tags[$i]["slug"], $tags_remove)) {
    ...
    static function eh_crm_edit_agent_html() {
        ...
        $access = '<input type="checkbox" style="margin-top: 0;" class="form-control" name="edit_agents_rights_' . $user_id . '" id="edit_agents_rights_reply" value="reply" ' . $reply . '> Reply to Tickets<br>
                    <input type="checkbox" style="margin-top: 0;" class="form-control" name="edit_agents_rights_' . $user_id . '" id="edit_agents_rights_delete" value="delete" ' . $delete . '> Delete Tickets<br>
                    <input type="checkbox" style="margin-top: 0;" class="form-control" name="edit_agents_rights_' . $user_id . '" id="edit_agents_rights_manage" value="manage" ' . $manage . '> Manage Tickets<br>';

        if (in_array("WSDesk_Supervisor", $user->roles)) {
            $access .= '<input type="checkbox" style="margin-top: 0;" class="form-control" name="edit_agents_rights_' . $user_id . '" id="edit_agents_rights_settings" value="settings" ' . $settings . '> Show Settings Page<br>
                        <input type="checkbox" style="margin-top: 0;" class="form-control" name="edit_agents_rights_' . $user_id . '" id="edit_agents_rights_agents" value="agents" ' . $agents . '> Show Agents Page<br>';
        }
        $tags = '';
        if (!empty($tags_temp)) {
        ...
        $output = '<span class="crm-divider"></span>
                    <div class="crm-form-element">
                        ...
                        <div class="col-md-9">
                            <span class="help-block">Mention Access Rights that are going to assign for selected User(s)?.</span>
                    ...
                    <div class="crm-form-element">
                        ...
                        <div class="col-md-9">
                            <span class="help-block">Wish to edit ticket tags for Users? <br>The tickets will be assigned automatically if Default Assignee is [ Depands on Tags ]</span>
    ...
    static function eh_crm_new_ticket_post() {
        ...
        $title = $post_values['request_title'];
        $desc = str_replace("\n", '<br/>', $post_values['request_description']);
        $args = array(
            'ticket_email' => $email,
            'ticket_title' => $title,
            'ticket_content' => $desc,
        ...
        echo "<div class='alert'>" . __("Support Request Received Successfully") . "</div>";
    ...
    static function eh_crm_ticket_single_view_gen($ticket_id) {
        ...
        ?>
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb col-md-8" style="margin: 0 !important;background: none !important;padding: 8px 0px !important; ">
                    ...
                    <?php
                        ...
                        {
                            echo '<button type="button" class="btn btn-warning ticket_action_delete pull-right" id="'.$ticket_id.'">
                                    <span class="glyphicon glyphicon-trash"></span> Delete Ticket
                                  </button>';
                        }
                    ?>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-md-9">
                    <div class="panel panel-default single_ticket_panel">
                        <div class="panel-heading">
                            <p style="margin-top: 5px;font-size: 16px;">
                                <?php
                                    if(in_array("manage_tickets", $access))
                                    {
                                        echo '<input type="text" value="'.$current[0]['ticket_title'].'" id="ticket_title_'.$ticket_id.'" class="ticket_title_editable">';
                                    }
                                    else
                                    {
                            ...
                            <p style="margin-top: 5px;">
                                ...
                                ?>
                                | <i class="glyphicon glyphicon-calendar"></i> <?php echo get_date_from_gmt($current[0]['ticket_date'], "M d, Y h:i:s A"); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group col-md-12">
                                                                ...
                                                                <div class="btn-group pull-right">
                                                                    <button type="button" class="btn btn-send dropdown-toggle ticket_reply_action_button_<?php echo $ticket_id; ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <?php
                                                ...
                                                for($s=0;$s<count($reply_id);$s++)
                                                {
                                                    ...
                                                    if($reply_ticket[0]['ticket_author']!=0)
                                                    {
                                                        ...
                                                        $replier_pic = get_avatar_url($reply_ticket[0]['ticket_author']);
                                                    }
                                                    else
                                                    {
                                                        $replier_name = "Guest";
                                                        $replier_pic = get_avatar_url($reply_ticket[0]['ticket_email']);
                                                    }
                                                    $attachment = "";
                                                    ...
                                                    switch ($reply_ticket[0]['ticket_category']) {
                                                            ...
                                                            echo '
                                                                <article class="row">
                                                                    <div class="col-md-2 col-sm-2 hidden-xs">
                                                                        <figure class="thumbnail" style="background-color:#EFDAA3 !important">
                                                                            <img class="img-responsive" src="'.$replier_pic.'" />
                                                                            <figcaption class="text-center">'.$replier_name.'</figcaption>
                                                                        </figure>
                                                                    </div>
                                                                    <div class="col-md-10 col-sm-10">
                                                                        <div class="panel panel-default arrow_tic left" style="box-shadow:2px 5px 1px rgba(0, 0, 0, .05) !important">
                                                                            <div class="panel-body">
                                                                                <header class="text-left">
                                                                                    <i class="glyphicon glyphicon-user"></i> '.$replier_email.' | 
                                                                                    <i class="glyphicon glyphicon-calendar"></i> '.get_date_from_gmt($reply_ticket[0]['ticket_date'], "M d, Y h:i:s A").'
                                                                                    | [ Requester ]
                                                                                </header>
                                                                                <hr>
                                                                                <div class="comment-post">
                                                                                    <p>
                                                                                        '.preg_replace("~[[:alpha:]]+://[^<>[:space:]]+[[:alnum:]/]~","<a href=\"\\0\" title='\\0' target='_blank'>\\0</a>", stripslashes($reply_ticket[0]['ticket_content'])).'
                                                                                    </p>
                                                                                    '.$attachment.'
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        case "agent_reply":
                                                            echo '
                                                                <article class="row">
                                                                    <div class="col-md-10 col-sm-10">
                                                                        <div class="panel panel-default arrow_tic right" style="box-shadow:2px 5px 1px rgba(0, 0, 0, .05) !important">
                                                                            <div class="panel-body">
                                                                                <header class="text-left">
                                                                                    <i class="glyphicon glyphicon-user"></i> '.$replier_email.' | 
                                                                                    <i class="glyphicon glyphicon-calendar"></i> '.get_date_from_gmt($reply_ticket[0]['ticket_date'], "M d, Y h:i:s A").'
                                                        ...
                                                        case 'agent_note':
                                                            echo '
                                                                <article class="row">
                                                                    ...
                                                                    <div class="col-md-2 col-sm-2 hidden-xs">
                                                                        <figure class="thumbnail" style="background-color: aliceblue; !important">
                                                                            <img class="img-responsive" src="'.$replier_pic.'" />
                                                                            <figcaption class="text-center">'.$replier_name.'</figcaption>
                                                                        </figure>
                                                                    </div>
    ...
    static function eh_crm_ticket_refresh_left_bar() {
        ...
        ?>
            ...
            <ul class="nav nav-pills nav-stacked" id="labels">
                <?php
                    for ($i = 0; $i < count($avail_labels); $i++) {
            ...
            if(!empty($users_data))
            {
                ...
                <ul class="nav nav-pills nav-stacked" id="agents">
                    <?php
                        for ($i = 0; $i < count($users_data); $i++) {
    ...
    static function eh_crm_ticket_refresh_right_bar() {
        $active = $_POST['active'];
        $current_page_no = $_POST['current_page'];
        $pagination = $_POST['pagination_type'];
        ...
        switch ($active) {
            case "all":
                ...
                $section_tickets_id = eh_crm_get_ticket_value_count("ticket_parent",0,false,"","","ticket_id","DESC",$ticket_rows,$offset);
                break;
            case "registeredU":
                $table_title = 'Registered Users Tickets';
                $total_count = count(eh_crm_get_ticket_value_count("ticket_author",0,TRUE,"ticket_parent",0));
                $section_tickets_id = eh_crm_get_ticket_value_count("ticket_author",0,TRUE,"ticket_parent",0,"ticket_id","DESC",$ticket_rows,$offset);
                break;
            case "guestU":
                $table_title = 'Guest Users Tickets';
                $total_count = count(eh_crm_get_ticket_value_count("ticket_author",0,FALSE,"ticket_parent",0));
                $section_tickets_id = eh_crm_get_ticket_value_count("ticket_author",0,false,"ticket_parent",0,"ticket_id","DESC",$ticket_rows,$offset);
                break;
            case "unassigned":
                $table_title = 'Unassigned Tickets';
                $total_count = count(eh_crm_get_ticketmeta_value_count("ticket_assignee",array(),"ticket_id"));
                $section_tickets_id = eh_crm_get_ticketmeta_value_count("ticket_assignee",array(),"ticket_id","DESC",$ticket_rows,$offset);
                break;
            default:
                if (strpos($active, 'label_') !== false) 
                {
                    ...
                    $section_tickets_id = eh_crm_get_ticketmeta_value_count("ticket_label",$active,"ticket_id","DESC",$ticket_rows,$offset);
                } 
                elseif (strpos($active, 'tag_') !== false) 
                {
                    ...
                    $section_tickets_id = eh_crm_get_ticketmeta_value_count("ticket_tags",$active,"ticket_id","DESC",$ticket_rows,$offset);
                }
                else 
                {
                    for($i=0;$i<count($users_data);$i++)
                    ...
                    $section_tickets_id = eh_crm_get_ticketmeta_value_count("ticket_assignee",$active,"ticket_id","DESC",$ticket_rows,$offset);
                }
                break;
        }
        $avail_caps = array("reply_tickets","delete_tickets","manage_tickets");
                        ...
                        else
                        {
                            for($i=0;$i<count($section_tickets_id);$i++)
                            {
                                ...
                                if(!empty($latest_reply_id))
                                {
                                    ...
                                    $latest_content['content'] = preg_replace("~[[:alpha:]]+://[^<>[:space:]]+[[:alnum:]/]~","<a href=\"\\0\" title='\\0' target='_blank'>\\0</a>", $latest_ticket_reply[0]['ticket_content']);
                                ...
                                {
                                    $latest_content['content'] = preg_replace("~[[:alpha:]]+://[^<>[:space:]]+[[:alnum:]/]~","<a href=\"\\0\" title='\\0' target='_blank'>\\0</a>", $current[0]['ticket_content']);
    ...
    static function eh_crm_ticket_reply_agent() {
        ...
        {
            CRM_Ajax::eh_crm_fire_email($gen_id);
        }
                                                    ...
                                                    <div class="status-upload">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group col-md-12">
                                                                ...
                                                                <div class="btn-group pull-right">
                                                                    <button type="button" class="btn btn-send dropdown-toggle ticket_reply_action_button_new" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                      Submit as <span class="caret"></span>
                                                                    </button>
                                                                    <ul class="dropdown-menu">
                                                                        <?php
    ...
    static function eh_crm_check_ticket_request() {
        ...
        {
            die(json_encode(array("status"=>"login","url"=>wp_login_url($url))));
        }
    }
    ...
    static function eh_crm_ticket_single_view_client_gen($ticket_id) {
        ...
        ?>
            ...
            <hr />
            <div class="row">
                <div class="panel panel-default single_ticket_panel" id="<?php echo $ticket_id;?>">
                        <div class="panel-heading">
                            <p style="margin-top: 5px;font-size: 16px;">
                                <?php
                                    echo $current[0]['ticket_title'];
                                                    ...
                                                    <div class="status-upload">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group col-md-12">
                                                                ...
                                                                <div class="btn-group pull-right">
                                                                    <button type="button" class="btn btn-primary dropdown-toggle ticket_reply_action_button" data-loading-text="Submitting Reply..." id="<?php echo $ticket_id; ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                      Submit
                                                                    </button>
                                                                  </div>
                                                            </div>
                            ...
                            <div class="col-md-10 col-sm-10">
                                <div class="panel panel-default arrow_tic left" style="box-shadow:2px 5px 1px rgba(0, 0, 0, .05) !important">
                                    <div class="panel-body">
                                        ...
                                        <div class="comment-post">
                                            <p>
                                                '.preg_replace("~[[:alpha:]]+://[^<>[:space:]]+[[:alnum:]/]~","<a href=\"\\0\" title='\\0' target='_blank'>\\0</a>", $reply_ticket[0]['ticket_content']).'
                                            </p>
                                            '.$attachment.'
                                        </div>
                                    </div>
    ...
    static function eh_crm_fire_email($ticket_id) {
        ...
        $message = str_replace('[date]',$ticket[0]['ticket_date']." GMT",$message);
