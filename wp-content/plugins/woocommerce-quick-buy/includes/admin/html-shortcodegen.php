...
<table id="wcqb_shortcodegen" class="widefat striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="selected_product" class="wc-product-search" data-placeholder="<?php _e(" Search For Product ",WCQB_TXT); ?>" data-action="woocommerce_json_search_products" data-selected="" style="width: 50%;" id="product_id">
