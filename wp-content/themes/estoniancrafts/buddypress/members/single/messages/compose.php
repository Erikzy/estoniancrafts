<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main" enctype="multipart/form-data">
	...
	<ul class="first acfb-holder">
		<li>
			...
			<input type="text" name="send-to-input"  value="<?php bp_message_get_recipient_usernames(); ?>" class="send-to-input" id="send-to-input" />
		</li>
	</ul>
	...
	<div class="submit">
		<input type="submit" class="btn btn-style-link btn-read-more more-link" value="<?php esc_attr_e( "Send Message", 'buddypress' ); ?>" name="send" id="send" />
	</div>
