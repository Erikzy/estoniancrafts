...
<?php do_action( 'dokan_product_listing_filter_before_form' ); ?>
    ...
    <form method="get" class="dokan-form-inline dokan-w6">
        ...
        <div class="dokan-form-group dokan-right">
            <input type="text" class="dokan-form-control search-f" name="product_search_name" placeholder="<?php _e( 'Search Products', 'dokan' ) ?>" value="<?php echo isset( $_GET['product_search_name'] ) ? $_GET['product_search_name'] : '' ?>">
        </div>
