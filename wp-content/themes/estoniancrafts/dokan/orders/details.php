    ...
    <div class="dokan-w4 mydokan-w12" style='margin-left:10px'>
       <!--  <div class="row dokan-clearfix"> -->
            <div class="" style="width:100%">
                ...
                echo ' <strong><a class="eabi-print-packing-slip" href="' .'admin-ajax.php?action=' . WC_Eabi_Postoffice::ACTION_PRINT_PACKING_SLIP . '&order_id=' . $order->id . '&slip_index=0'. '">(' . __('Print packing slip', WC_Eabi_Postoffice::PLUGIN_TEXT_DOMAIN) . ')</a></strong>';
